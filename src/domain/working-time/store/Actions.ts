...
export const fetchPublicHolidaysAction =
    actionCreator.async<PublicHolidaysParams, PublicHoliday[], Error>("FETCH_PUBLIC_HOLIDAYS")
...
export const calculateSummaryAction =
    actionCreator.async<{ profile: Profile }, SummaryDay[], Error>("CALCULATE_SUMMARY")

export const updateSummaryEntryAction = actionCreator<SummaryDay>("UPDATE_SUMMARY_ENTRY")

export const generatePdfReportAction =
    actionCreator.async<{ summary: SummaryDay[]; profile: Profile; activeDate: ActiveDateParams }, Blob, Error>(
        "GENERATE_PDF_REPORT"
    )
